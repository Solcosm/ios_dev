...
class LanguageListController: UITableViewController {
    ...
    private let languageNames: [String] = ["English", "French", "German", "Japanese"]
    private let languageCodes: [String] = ["en", "fr", "de", "jp"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        //Popover Code so it doesn't stretch the entire screen
